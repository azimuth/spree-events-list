...
desc 'Generate documentation for the events_list extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'EventsListExtension'
...
desc 'Test the events_list extension.'
...
namespace :test do
  desc 'Functional test the events_list extension.'
  ...
  desc 'Unit test the events_list extension.'
